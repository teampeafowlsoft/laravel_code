...
class Category extends Model
{
    ...
    {
//        return $this->hasMany(Service::class, 'sub_category_id')->groupBy('group_id');
        return $this->hasMany(Service::class, 'sub_category_id')->groupBy('group_id')->withoutGlobalScopes();
    }
