                ...
                <!-- Category Setup -->
                    <div class="card category-setup mb-30">
                        <div class="card-body p-30">
                            <form action="{{route('admin.category.update',[$category[0]->group_id])}}" method="post"
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="float-end">
                                                        <a class="btn btn--secondary btn-sm"
                                                           href="{{route('admin.category.create')}}"><span
                                                ...
                                                <div class="upload-file">
                                                    ...
                                                    <div class="upload-file__img">
                                                        <img
                                                            ...
                                                            src="{{asset('storage/app/public/category')}}/{{$category[0]->image}}"
                                                            alt="">
                                                    </div>
