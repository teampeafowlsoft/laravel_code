                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="switcher" data-bs-toggle="modal"
                                                            ...
                                                            <input class="switcher_input"
                                                                   onclick="route_alert('{{route('admin.sub-category.status-update',[$category->group_id])}}','{{translate('want_to_update_status')}}')"
                                                    ...
                                                    <td>
                                                        <div class="table-actions">
                                                            <a href="{{route('admin.sub-category.edit',[$category->id,$category->group_id])}}"
                                                            ...
                                                            <form
                                                                action="{{route('admin.sub-category.delete',[$category->group_id])}}"
