                ...
                <!-- Category Setup -->
                    <div class="card category-setup mb-30">
                        <div class="card-body p-30">
                            <form action="{{route('admin.sub-category.update',[$sub_category[0]->group_id])}}"
                                  method="post"
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="float-end">
                                                        <a class="btn btn--secondary btn-sm"
                                                           href="{{route('admin.sub-category.create')}}"><span
                                            ...
                                            <div>
                                                <div class="upload-file">
                                                    ...
                                                    <div class="upload-file__img">
                                                        <img
                                                            src="{{asset('storage/app/public/category')}}/{{$sub_category[0]->image}}"
