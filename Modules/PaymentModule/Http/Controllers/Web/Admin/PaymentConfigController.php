...
class PaymentConfigController extends Controller
{
    ...
    {
        $validation = [
            'gateway' => 'required|in:sslcommerz,paypal,stripe,razor_pay,senang_pay,paytabs,paystack,paymob,paytm,flutterwave,liqpay,bkash,mercadopago,cash_after_service,digital_payment,tap_pay',
        ...
        } elseif ($request['gateway'] == 'tap_pay') {
            $additional_data = [
                'status' => 'required|in:1,0',
//                'callback_url' => 'required',
                'public_key' => 'required',
...
//                'merchant_email' => 'required'
    ...
    public function pay_redirect(Request $request){
        $pay_status = $request->payment_status;
        return view('paymentmodule::payment-status',compact('pay_status'));
    }
}
