...
//Route::group(['prefix'=>'payment'],function () {
    ...
    //TAP-PAY
    Route::group(['prefix'=>'tap-pay','as'=>'tap-pay.'], function () {
        Route::get('pay','TapPayController@index');
        Route::post('payment','TapPayController@payment')->name('payment')->WithoutMiddleware('detectUser');
        //Route::post('payment','TapPayController@payment')->name('payment');
        Route::get('callback/{tkn}','TapPayController@callback')->name('callback')->WithoutMiddleware('detectUser');
    });

    //KNET-PAY
    Route::group(['prefix'=>'knet-pay','as'=>'knet-pay.'], function () {
        Route::get('pay','KnetPayController@index');
        Route::post('payment','KnetPayController@payment')->name('payment')->WithoutMiddleware('detectUser');
        //Route::post('payment','TapPayController@payment')->name('payment');
        Route::get('callback/{tkn}','KnetPayController@callback')->name('callback')->WithoutMiddleware('detectUser');
    });
