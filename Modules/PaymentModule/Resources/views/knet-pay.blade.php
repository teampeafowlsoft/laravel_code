                    ...
                    <div class="col-12 col-md-12 mb-30">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="page-title text-center">KNET pay</h4>
                            </div>
                            <div class="card-body p-30">
                                <form method="POST" action="{!! route('knet-pay.payment',['token'=>$token]) !!}" accept-charset="UTF-8"
                                      class="form-horizontal"
                                      role="form">

                                    <div class="form-floating mb-30 pb-4 text-center">
                                        <img class="img-fluid" style="height: 80px !important;" src="https://seeklogo.com/images/K/knet-logo-2360944FA2-seeklogo.com.png">
                                    </div>
