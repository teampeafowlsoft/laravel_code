...
class AddressController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $existingAddress = $this->address->where('user_id',$request->user()->id)->where('lat', $request->lat)
            ->where('lon', $request->lon)
            ->first();

        if ($existingAddress) {
            return response()->json(response_formatter(DEFAULT_400, "Address with the same lat and lon already exists."), 400);
        }
        ...
        $address->contact_person_name = ($request->contact_person_name != null)?$request->contact_person_name:'';
        $address->contact_person_number = ($request->contact_person_number != null)?$request->contact_person_number:'';
    ...
    public function destroy(Request $request): JsonResponse
    {
        ...
        $address = $this->address
            ...
            ->whereIn('id', $request['address_ids'])->first();
