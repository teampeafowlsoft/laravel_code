...
class ConfigController extends Controller
{
    ...
    public function configuration(Request $request): JsonResponse
    {
        ...
        $apple_social_login = business_config('apple_social_login', 'social_login');
        ...
        return response()->json(response_formatter(DEFAULT_200, [
            ...
            'app_url_android' => 'https://play.google.com/store/apps/details?id=com.ta9li7',
            'app_url_ios' => 'https://apps.apple.com/us/app/repair-app/id1390965628',
            ...
            'payment_gateways' => BusinessSettings::select('live_values')
            ...
            'apple_social_login' => (int) ($apple_social_login->live_values ?? 0),
        ]), 200);
    }
