        ...
        <div class="container-fluid">
            ...
            <div class="mb-3">
                <ul class="nav nav--tabs nav--tabs__style2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{$web_page=='orders'?'active':''}}"
                           href="{{url()->current()}}?web_page=orders">{{translate('orders')}}</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-pane fade show active" id="boookings-tab-pane">
                    <div class="d-flex justify-content-end border-bottom mb-10">
                        <div class="d-flex gap-2 fw-medium me-4">
                            <span class="opacity-75">{{translate('Total_Order')}}:</span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="data-table-top d-flex flex-wrap gap-10 justify-content-between">
                                <form action="{{url()->current()}}?web_page=orders"
                                ...
                                <table id="example" class="table align-middle">
                                    ...
                                    @foreach($bookings as $booking)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.orderpool.details', [$booking->id,'web_page'=>'details'])}}" class="btn btn--light text-capitalize">
