        ...
        <div>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <th class="text-center text-uppercase">{{translate('final_cost')}}</th>
...
{{--                            {{$item->variant_key}}--}}
                ...
                <tr>
                    <td colspan="4"></td>
                    <td class="">{{translate('Sub_Total_(Vat _Excluded)')}}</td>
                ...
                <tr>
                    <td colspan="4"></td>
                    <td class="">{{translate('delivery_charge')}} </td>
                    <td>{{with_currency_symbol($booking->total_delivery_charge + $booking->total_shipping_charge)}}</td>
                </tr>
                <tr>
                    <td colspan="4"></td>
                    <td class="">{{translate('VAT')}} %</td>
                    <td>{{with_currency_symbol($booking->total_tax_amount)}}</td>
                </tr>
                <tr>
                    <td colspan="4"></td>
                    <td class="fw-700 border-top">{{translate('Total')}}</td>
                    <td class="fw-700 border-top">{{with_currency_symbol(($sub_total + $booking->total_tax_amount + $booking->total_delivery_charge + $booking->total_shipping_charge) - ($booking->total_coupon_discount_amount + $booking->total_campaign_discount_amount))}}</td>
                </tr>
                </tfoot>
            </table>
        </div>
