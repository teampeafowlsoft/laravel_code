...
@section('title',translate('Order_Status'))
                                    ...
                                    <div class="border-bottom pb-3">
                                        <div class="row pb-1 gy-2">
                                            <div class="col-6 col-lg-3">
                                                <div>
                                                    <h4 class="c1 mb-2 pb-1">{{translate('Order_Placed')}}</h4>
                                                    <p class="opacity-75">{{date('d-M-Y h:ia',strtotime($booking->created_at))}}</p>
                                                </div>
                                            </div>
                                            <div class="col-6 col-lg-3">
                                                <div>
                                                    <h4 class="c1  mb-2 pb-1">{{translate('Order_Status')}}</h4>
                                            ...
                                            <div class="col-6 col-lg-3">
                                                <div>
                                                    <h4 class="c1  mb-2 pb-1">{{translate('Order_Amount')}}</h4>
                                                ...
                                                <div class="timeline-steps">
                                                    <div class="timeline-step completed">
                                                        ...
                                                        <div class="timeline-info">
                                                            <p class="timeline-title text-capitalize">{{translate('Order_Placed')}}</p>
                                        ...
                                        <div class="col-md-6 col-xl-4 d-flex justify-content-center">
                                            <div class="d-flex flex-column gap-30">
                                                <div class="c1-light-bg radius-10 py-3 px-4">
                                                    ...
                                                    <h5 class="c1 mb-2">{{isset($booking->detail[0]->service) ? Str::limit($booking->detail[0]->service->contact_person_name, 30) : ''}}</h5>
                                                    <ul class="list-info">
                                                        <li>
                                                            <span class="material-icons">phone_iphone</span>
                                                            <a href="tel:{{isset($booking->detail[0]->service) ? $booking->detail[0]->service->contact_person_phone : ''}}">
                                                                {{isset($booking->detail[0]->service) ? $booking->detail[0]->service->contact_person_phone : ''}}
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <span class="material-icons">map</span>
                                                            <p>{{isset($booking->detail[0]->service) ? Str::limit($booking->detail[0]->service->company_address, 30) : ''}}</p>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
