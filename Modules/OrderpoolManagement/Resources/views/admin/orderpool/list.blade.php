...
@section('content')
    ...
    <div class="filter-aside">
        ...
        <form action="{{route('admin.orderpool.list', ['order_status'=>$query_param['order_status']])}}" method="POST"
                ...
                <div class="col-12 col-md-6">
                    <div class="float-end">
                        <a class="btn btn--secondary btn-sm  {{$order_status == 'cancelled' ? 'd-none' : ''}}"
                           ...
                           {{route('admin.orderpool.list', ['order_status'=>'processed'])}}
                           @elseif($order_status == 'processed')
                           {{route('admin.orderpool.list', ['order_status'=>'shipped'])}}
                           @elseif($order_status == 'shipped')
                           {{route('admin.orderpool.list', ['order_status'=>'delivered'])}}
                           @elseif($order_status == 'delivered')
                           {{route('admin.orderpool.list', ['order_status'=>'cancelled']) }}
                           @else
                           {{''}}
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                            <li><a class="dropdown-item"
                                                   href="{{route('admin.orderpool.download')}}?order_status={{$query_param['order_status']}}">{{translate('excel')}}</a>
                                            </li>
                                        </ul>
                                    </div>
