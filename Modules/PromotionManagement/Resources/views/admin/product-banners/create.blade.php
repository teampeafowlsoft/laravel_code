...
@section('title',translate('products_banners'))
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title">{{translate('products_banners')}}</h2>
                    </div>
                    ...
                    <div
                        ...
                        <ul class="nav nav--tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{$resource_type=='product'?'active':''}}"
                                   href="{{url()->current()}}?resource_type=product">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center gap-3">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{route('admin.productbanner.download')}}?search={{$search}}">
                                                        {{translate('excel')}}
                                                    </a>
                                                </ul>
                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img width="70" height="70" onerror="this.src='{{asset('public/assets/admin-module/img/media/banner-upload-file.png')}}'"
                                                             src="{{asset('storage/app/public/productbanner')}}/{{$item->banner_image}}"
                                                             alt="">
                                                    </td>
                                                    ...
                                                    <td>
                                                        <label class="switcher">
                                                            <input class="switcher_input" onclick="route_alert('{{route('admin.productbanner.status-update',[$item->id])}}','{{translate('want_to_update_status')}}')"
                                                    ...
                                                    <td>
                                                        <div class="table-actions">
                                                            <a href="{{route('admin.productbanner.edit',[$item->id])}}"
                                                            ...
                                                            <form action="{{route('admin.productbanner.delete',[$item->id])}}"
