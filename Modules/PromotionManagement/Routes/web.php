...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin','mpc:promotion_management']], function () {
    ...
    Route::group(['prefix' => 'productbanner', 'as' => 'productbanner.'], function () {
        Route::any('create', 'ProductBannerController@create')->name('create');
        Route::post('store', 'ProductBannerController@store')->name('store');
        Route::get('edit/{id}', 'ProductBannerController@edit')->name('edit');
        Route::put('update/{id}', 'ProductBannerController@update')->name('update');
        Route::any('status-update/{id}', 'ProductBannerController@status_update')->name('status-update');
        Route::delete('delete/{id}', 'ProductBannerController@destroy')->name('delete');
        Route::any('download', 'ProductBannerController@download')->name('download');
    });
