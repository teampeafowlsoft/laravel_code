...
use Modules\ProviderManagement\Http\Controllers\Web\Provider\Report\OrderReportController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin']], function () {
    Route::group(['prefix' => 'provider', 'as' => 'provider.'], function () {
        ...
        Route::get('get-sub-cat-ids', 'ProviderController@getSubCatIDs')->name('get-sub-cat-ids');

        Route::post('delete-identification/{rm}/{uid}',[ProviderController::class,'deleteIdentification'])->name('delete_identification');

        Route::get('create-business/{id}', 'ProviderController@create_business')->name('create-business');
