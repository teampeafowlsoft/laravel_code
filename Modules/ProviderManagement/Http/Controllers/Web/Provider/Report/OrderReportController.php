...
class OrderReportController extends Controller
{
    ...
    public function get_order_report(Request $request)
    {
        ...
        //Dropdown data
        $zones = $this->zone->ofStatus(1)->where('lang_id',1)->select('id', 'name')->get();
        $categories = $this->productcategories->ofType('main')->where('lang_id',1)->select('id', 'name')->get();
        $sub_categories = $this->productcategories->ofType('sub')->where('lang_id',1)->select('id', 'name')->get();
        ...
        return view('providermanagement::provider.report.orderbooking', compact('zones', 'categories', 'sub_categories', 'search', 'filtered_bookings', 'bookings_count', 'booking_amount', 'chart_data', 'query_params'));
    }
