...
class ExpenseReportController extends Controller
{
    ...
    public function get_business_expense_report(Request $request)
    {
        ...
        $categories = $this->categories->ofType('main')->where('lang_id',1)->select('id', 'name')->get();
        $sub_categories = $this->categories->ofType('sub')->where('lang_id',1)->select('id', 'name')->get();
    ...
    public function get_business_expense_report_download(Request $request)
    {
        ...
        return (new FastExcel($filtered_booking_amounts))->download(time().'-business-earning-report.xlsx');
    }
