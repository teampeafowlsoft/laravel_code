                                ...
                                <table id="example" class="table align-middle">
                                    ...
                                    @foreach($providers as $provider)
                                        <tr>
                                            ...
                                            @if($provider->destination_id == null || $provider->response_business_id == null || $provider->business_entity_id == null)
                                                <td>
                                                    <a href="{{route('admin.provider.create-business',[$provider->id])}}"
