                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('provider.report.order')}}" method="POST">
                                @csrf
                                <div class="row">
                                ...
                                <div class="d-flex flex-wrap align-items-center gap-3">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                            <li><a class="dropdown-item" href="{{route('provider.report.order.download').'?'.http_build_query(request()->all())}}">{{translate('Excel')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
