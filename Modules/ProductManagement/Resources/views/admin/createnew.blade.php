                                    ...
                                    <div class="tab-pane fade show active" id="english">
                                        <div class="row">
                                            ...
                                            <div class="col-6 mb-5 mb-lg-0">
                                                <div class="form-group mb-30">
                                                    <label for="description"><strong class="text-black"> {{translate('description')}}
                                                            <span
                                                                class="text-danger">*</span></strong></label>
                                                    <section id="editor">
...
{{--                                                                        <label for="packate_measurement_sell_price"><strong--}}
{{--                                                                                class="text-black"> {{translate('selling_price')}} <span--}}
{{--                                                                                    class="text-danger">*</span> </strong></label>--}}
{{--                                                                        <input type="text" name="packate_measurement_sell_price[]" id="sell_price_id" class="form-control"--}}
...
{{--                                                                    </div>--}}
                                                                    ...
                                                                    <div class="form-group mb-30 col-md-2 d-none">
                                                                        ...
                                                                        <div class="packate_div">
                                                                            <input type="text" class="form-control"
                                                                                   name="packate_measurement_discount_price[]"
                                                                                   id="discount_price_id"
                                                                                   onkeypress="return validateFloatKeyPress(this,event);"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 mb-30">
                                                            <div class="form-group">
                                                                <label for="vendor"> <strong
                                                                        class="text-black">{{translate('sold_by')}} <span
                                                                            class="text-danger">*</span></strong></label>
                                                                <select class="form-control theme-input-style w-100"
                                                                        name="vendor" id="vendor">
                                                                    <option selected value=""
                                                                            disabled>--Select Company--</option>
                                                ...
                                                <div class="tab-pane fade" id="media">
                                                    <div class="row">
                                                        <div class="col-lg-6 mb-5 mb-lg-0">
                                                            <div class="form-group mb-30">
                                                                <label for="image"
                                                                       class="mb-3"><strong class="text-black">{{translate('main_image')}}
                                                                        <span
                                                                            class="text-danger">*</span></strong></label>
{{--                                                                <div class="form-floating">--}}
                                                                    <div class="field">
                                                        ...
                                                        <div class="col-lg-6 mb-5 mb-lg-0">
                                                            <div class="form-group mb-30">
                                                                <label for="other_images"
                                                                    class="mb-3"><strong class="text-black">{{translate('add_multi_img')}}
                                                                        </strong></label>
                                                                    <div class="field">
                                                        ...
                                                        <div class="col-lg-12 mb-5 mb-lg-0">
                                                            <div class="table-responsive">
                                                                <table id=""
                                                                    ...
                                                                    <tbody>
                                                                    @php $i=1; @endphp
                                                                    <input class="d-none" type="text" name="total_zone"
                                                                    ...
                                                                    @foreach($zones as $key=>$zone)
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="text" class="form-control"
                                                                                       ...
                                                                                       name="delivery_charge[{{$i}}]" id="delivery_charge">
                                                                                <input
                                                                                    type="hidden"
                                                                                    class="form-control"
                                                                                    name="zone_id[{{$i}}]"
                                    ...
                                    <div class="tab-pane fade" id="arabic">
                                        <div class="row">
                                            <div class="col-lg-12 mb-5 mb-lg-0">
                                                <div class="form-group mb-30">
                                                    <label for="name"><strong
                                                            class="text-black"> {{translate('arabic_product_name')}} <span
                                                                class="text-danger">*</span> </strong></label>
                                            ...
                                            <div class="col-lg-6 mb-5 mb-lg-0">
                                                ...
                                                <div class="form-group mb-30">
                                                    <label for="sku_arabic"><strong class="text-black">{{translate('reference_code/sku_arabic')}}</strong><i
                                                            class="text-danger asterik">*</i></label>
                                                            ...
                                                            <div id="arabic_packate_div">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group mb-30 col-md-2 d-none">
                                                                        ...
                                                                        <div class="arabic_packate_div">
                                                                            <input type="text" class="form-control"
                                                                                   name="arabic_packate_measurement_discount_price[]"
                                                                                   id="arabic_discount_price_id"
                                                                                   onkeypress="return validateFloatKeyPress(this,event);"
...
{{--                                                                </div>--}}
                                                        ...
                                                        <div class="col-lg-6 mb-5 mb-lg-0">
                                                            <div class="mb-30">
                                                                <label
                                                                    class="mb-3"><strong>{{translate('add_multi_img')}}
                                                                      </strong></label>
                                                                <div class="form-floating">
                                                                    <div class="field">
                                                        ...
                                                        <div class="col-lg-12 mb-5 mb-lg-0">
                                                            <div class="table-responsive">
                                                                <table id=""
                                                                    ...
                                                                    <tbody>
                                                                    @php $i=1; @endphp
                                                                    <input class="d-none" type="text" name="arabic_total_zone"
                                                                    ...
                                                                    @foreach($arabic_zones as $key=>$arabiczone)
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="text" class="form-control"
                                                                                       value="0"
                                                                                       placeholder="Enter Delivery charge"
                                                                                       name="arabic_delivery_charge[{{$i}}]" id="arabic_delivery_charge"><input
                                                                                    type="hidden"
                                                                                    class="form-control"
...
@push('script')
    ...
    <script>
        ...
        $('#arabic_lang').click(function () {
            ...
            $('#arabic_delivery_charge').val(deliveryCharge);
