...
@section('title',translate('update_product_campaign'))
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title">{{translate('update_product_campaign')}}</h2>
                    </div>

                    <div class="card mb-30">
                        <div class="card-body p-30">
                            <form action="{{route('admin.productcampaign.update',[$campaign->id])}}" method="POST" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="discount-type">
                                                    ...
                                                    <div>
                                                        <div class="upload-file">
                                                            ...
                                                            <div class="upload-file__img upload-file__img_banner">
                                                                <img
                                                                    src="{{asset('storage/app/public/productcampaign')}}/{{$campaign->cover_image}}"
                                                    ...
                                                    <div>
                                                        <div class="upload-file">
                                                            ...
                                                            <div class="upload-file__img">
                                                                <img
                                                                    src="{{asset('storage/app/public/productcampaign')}}/{{$campaign->thumbnail}}"
                                                                    onerror="this.src='{{asset('public/assets/admin-module')}}/img/media/upload-file.png'"
                                                                    alt="">
                                                            </div>
                                                            <span class="upload-file__edit">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center gap-4 mb-30">
                                        ...
                                        <div class="custom-radio">
                                            <input type="radio" id="product" name="discount_type"
                                                   value="product" {{$campaign->discount->discount_type=='product'?'checked':''}}>
                                    ...
                                    <div class="mb-30" id="product_selector"
                                         style="display: {{($campaign->discount->discount_type=='product' || $campaign->discount->discount_type=='mixed')?'block':'none'}}">
                                        <select class="product-select theme-input-style w-100" name="product_ids[]"
                                                multiple="multiple" id="product_selector__select">
                                            @foreach($products as $product)
                                                <option
                                                    value="{{$product->id}}" {{in_array($product->id,$campaign->discount->service_types->pluck('type_wise_id')->toArray())?'selected':''}}>
                                                    {{$product->name}}
                                                </option>
                                            @endforeach
                                        </select>
