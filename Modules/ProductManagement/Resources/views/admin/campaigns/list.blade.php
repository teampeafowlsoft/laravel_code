...
@section('title',translate('product_campaigns'))
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title">{{translate('product_campaigns')}}</h2>
                    </div>
                    ...
                    <div
                        ...
                        <ul class="nav nav--tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{$discount_type=='product'?'active':''}}"
                                   href="{{url()->current()}}?discount_type=product">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center gap-3">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{route('admin.productcampaign.download')}}?search={{$search}}">
                                                        {{translate('excel')}}
                                                    </a>
                                                </ul>
                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="switcher">
                                                            <input class="switcher_input" onclick="route_alert('{{route('admin.productcampaign.status-update',[$item->id])}}','{{translate('want_to_update_status')}}')"
                                                    ...
                                                    <td>
                                                        <div class="table-actions">
                                                            <a href="{{route('admin.productcampaign.edit',[$item->id])}}"
                                                            ...
                                                            <form action="{{route('admin.productcampaign.delete',[$item->id])}}"
