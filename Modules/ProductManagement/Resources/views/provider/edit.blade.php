                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body p-30">
                            ...
                            @endphp
                            <form action="{{route('provider.product.update',[$products[0]->group_id])}}" method="post"
                                                                ...
                                                                <div id="packate_div">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="form-group mb-30 col-md-2">
                                                                            ...
                                                                            <div class="packate_div">
                                                                                <input type="text" class="form-control"
                                                                                       name="packate_measurement_sell_price[]" onkeypress="return validateFloatKeyPress(this,event);"
                                                                                       placeholder="{{translate('selling_price')}} *" id="sell_price_id"
                                                                        ...
                                                                        <div class="mb-30 col-md-2">
                                                                            ...
                                                                            <div class="form-floating packate_div">
                                                                                <input type="text" class="form-control"
                                                                                       ...
                                                                                       value="{{$pv->packate_measurement_barcode}}"
                                                                                       placeholder="{{translate('product_name')}} *">
                                                                            </div>
                                                                        </div>
                                                                        <div class="mb-30 col-md-2">
                                                ...
                                                <div class="tab-pane fade" id="media">
                                                    <div class="row">
                                                        <div class="col-lg-6 mb-5 mb-lg-0">
                                                            <div class="form-group mb-30">
                                                                <label for="image"
                                                                       class="mb-3"><strong>{{translate('main_image')}}</strong></label>
                                                                    <div class="field">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade" id="arabic">
                                        <div class="row">
                                            <div class="col-lg-12 mb-5 mb-lg-0">
                                                <div class="form-group mb-30">
                                                    <label for="arabic_name"><strong class="text-black">{{translate('arabic_product_name')}} <span
                                                                class="text-danger">*</span></strong></label>
                                                        <input type="text" class="form-control"
                                                               name="arabic_name"
                                                                        ...
                                                                        <div class="form-group mb-30 col-md-2">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                       ...
                                                                                       value="{{$pva->packate_measurement_qty}}"
                                                                                       onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"
                                                                                       placeholder="{{translate('arabic_stocks/qty')}}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="mb-30 col-md-2">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                       ...
                                                                                       placeholder="{{translate('arabic_fssai_number')}} *" id="arabic_fssai_number_id"
                                                                        ...
                                                                        <div class="form-group mb-30 col-md-3">
                                                                            <label
                                                                                for="arabic_packate_measurement_images" class="text-black"><strong>{{translate('arabic_images')}}</strong></label>
                                                                            <div
                                                                                class="arabic_packate_div">
                                                                                <input type="file" class="form-control"
...
{{--                                                                    class="text-danger asterik">*</i></label>--}}
{{--                                                            <div class="form-group">--}}
{{--                                                                <select name='vendor_arabic' id='vendor' required--}}
{{--                                                                        class='js-select theme-input-style w-100'>--}}
{{--                                                                    <option--}}
