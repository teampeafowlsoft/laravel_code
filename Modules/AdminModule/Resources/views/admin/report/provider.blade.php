                                ...
                                <table class="table align-middle">
                                    <thead class="text-nowrap">
                                        <tr>
                                            ...
                                            <th>{{translate('Subscribes_Sub_Categories')}}</th>
                                    ...
                                    @forelse($filtered_providers as $key=>$provider)
                                        <tr>
                                            ...
                                            <td>{{(!empty($provider->owner->account->received_balance)) ? with_currency_symbol($provider->owner->account->received_balance +  + $provider->owner->account->total_withdrawn) : ''}}</td>
                                            <td>
                                                @php($commissions = [])
