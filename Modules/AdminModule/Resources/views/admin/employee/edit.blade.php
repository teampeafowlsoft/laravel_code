                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3 px-0">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" name="country_code" id="country_code"
                                                           ...
                                                           required="" value="{{substr($employee['country_code'],1)}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');">
                                                    <label>
                                            ...
                                            <div class="col-8">
                                                <div class="form-floating">
                                                    ...
                                                    <input type="hidden" id="phoneNumber" name="signaccountphone" value="{{$employee['phone']}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function (){
            $("#phone,#country_code").keyup(function (){
