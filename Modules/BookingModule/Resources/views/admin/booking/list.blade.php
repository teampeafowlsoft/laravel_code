        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="page-title-wrap mb-3">
                        <h2 class="page-title">
                            ...
                            @elseif($booking_status == 'accepted')
                                {{translate('accepted_booking')}}
                            @elseif($booking_status == 'ongoing')
                                {{translate('ongoing_booking')}}
                            @elseif($booking_status == 'completed')
                                {{translate('completed_booking')}}
                            @elseif($booking_status == 'canceled')
                                {{translate('canceled_booking')}}
                            @else
                                {{''}}
                            @endif
                        </h2>
                ...
                <div class="col-12 col-md-6">
                    <div class="float-end">
                        <a class="btn btn--secondary btn-sm  {{$booking_status == 'canceled' ? 'd-none' : ''}}"
                           href="@if($booking_status == 'pending')
                           {{route('admin.booking.list', ['booking_status'=>'accepted'])}}
                           @elseif($booking_status == 'accepted')
                           {{route('admin.booking.list', ['booking_status'=>'ongoing'])}}
                           @elseif($booking_status == 'ongoing')
                           {{route('admin.booking.list', ['booking_status'=>'completed'])}}
                           @elseif($booking_status == 'completed')
                           {{route('admin.booking.list', ['booking_status'=>'canceled']) }}
                           @else
                           {{''}}
                           @endif ">{{translate('next')}} <span
                                class="material-icons"
                                title="{{translate('Booking_Status')}}">chevron_right</span>
                        </a>
                    </div>
                </div>
                <div class="col-12">
