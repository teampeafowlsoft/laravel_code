...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin','mpc:booking_management']], function () {
    ...
    Route::group(['prefix' => 'booking', 'as' => 'booking.'], function () {
        ...
        Route::get('status-provider-update/{id}', 'BookingController@status_provider_update')->name('status_provider_update');
        Route::post('store', 'BookingController@store')->name('store');
        Route::get('remove-item/{id}', 'BookingController@remove_item')->name('remove_item');
    });
});
