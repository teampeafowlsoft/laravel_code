...
class TransactionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $transactions = $this->transaction->where('tran_type','service')
    ...
    public function product_transaction_list(Request $request)
    {
        $request->validate([
            'start_date' => 'date',
            'end_date' => 'date',
        ...
        return view('transactionmodule::admin.product-transaction-list',compact('transactions', 'data', 'trx_type', 'search'));
    }
}
